...
```
"""
_Bits.bits(s::AbstractString) = _Bits.bits(Word, s)
...
"""
    bits([IntT=UInt], dts::Union{AbstractVector{<:Integer},  NTuple{<:Any, <:Integer}}, n=length(dts))
...
```
"""
_Bits.bits(_digits::_VEC_LIKE, n=length(_digits)) = bits(UInt, _digits, n)
